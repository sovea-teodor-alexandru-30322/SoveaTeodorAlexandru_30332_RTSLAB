...
public class Supervisor_Transition_t_3 implements TransitionTemplate {
    ...
    public Supervisor_Transition_t_3(String name, PlaceHandlerTemplate PH, Integer delay){
        this.Init(name, PH);
        this.SetDelay(delay);
    }

    public Supervisor_Transition_t_3(String name, PlaceHandlerTemplate PH, Integer eet, Integer let) {
        this.Init(name, PH);
